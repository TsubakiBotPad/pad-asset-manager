...
def parse(extlist_data: bytes) -> Tuple[List[UnifiedAssetRecord], List[UnifiedAssetRecord]]:
    ...
    uncompressed_mons_data = read_structured_data(
        extlist_data, UncompressedAssetRecord, header.mons_count)
    uncompressed_cards_data = read_structured_data(
        extlist_data, UncompressedAssetRecord, header.cards_count)
    compressed_mons_data = read_structured_data(
        extlist_data, CompressedAssetRecord, header.mons_count)
    compressed_cards_data = read_structured_data(
        extlist_data, CompressedAssetRecord, header.cards_count)
